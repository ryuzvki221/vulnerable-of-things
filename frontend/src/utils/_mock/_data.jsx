export const titles = [
  ...
  "Security Flaw Allowing Hacking of Fitbit Smartwatches",
  "Sensitive Information Leakage via Nest Connected Cameras",
  "Arbitrary Command Injection in Ecobee Smart Thermostats",
  "Authentication Bypass Vulnerability in August Smart Locks",
  "Buffer Overflow in Samsung Smart TVs",
  "Denial of Service Vulnerability in Philips Hue Smart Bulbs",
  "User Data Leakage via Amazon Echo Smart Assistants",
  "Replay Attack on Arlo Connected Surveillance Cameras",
  "Exposed Unsecured API on LG Smart Refrigerators",
  "SQL Injection in Honeywell Connected Thermostats",
  "Authentication Flaw in Schlage Smart Locks",
  "User Access Bypass on LG Smart TVs",
  "Denial of Service on Ikea Tradfri Smart Bulbs",
  "User Data Leakage via Withings Smart Scales",
  "XML Injection Attack on Nest Thermostats",
  "Buffer Overflow Vulnerability in Asus Routers",
  "Covert Channel Attack on Xiaomi Surveillance Cameras",
  "Information Leakage via Emerson Smart Thermostats",
  "Authentication Bypass Vulnerability in Sony Bravia Smart TVs"
];

export const products = [
    "Smart Door Lock v2.0",
    "Smart Thermostat Pro",
    "HealthGuard Wearable Fitness Tracker",
    "HomeSafe Security Camera System",
    "KitchenMaster Smart Cooking Scale",
    "PetPal GPS Tracker Collar",
    "AutoGuard Car Security System",
    "EcoLight Smart Bulb",
    "LifeTracker Health Monitoring System",
    "GardenMate Smart Irrigation Controller",
    "SoundSense Wireless Earbuds",
    "KidSafe Smart Toy Collection",
    "TravelMate Smart Suitcase",
    "PowerGuard Home Energy Monitor",
    "CleanAir Smart Air Purifier",
    "OfficeMate Smart Desk Lamp",
    "HomeChef Smart Oven",
    "HealthGuard Pro Blood Pressure Monitor",
    "SecureSense Home Alarm System",
    "PetCare Smart Feeder"
  ];
